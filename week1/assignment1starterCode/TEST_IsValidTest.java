...
public class TEST_IsValidTest {
	
	private static void assertTestSetIsValid(final TEST_UtxoTestSet utxoTestSet) {
		final TEST_ValidationLists<Transaction> trxsValidation = utxoTestSet.getValidationLists();
	...
	public void testIsValidWithValidTransactions()
		...
		final TEST_UtxoTestSet utxoTestSet = TEST_UtxoTestSet.builder()
				.setPeopleSize(10)
				.setUtxoTxNumber(10)
