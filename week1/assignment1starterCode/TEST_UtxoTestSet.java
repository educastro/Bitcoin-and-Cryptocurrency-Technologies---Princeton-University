...
public class TEST_UtxoTestSet {
	 ...
	 */
	public TEST_ValidationLists<Transaction> getValidationLists() {
		return new TEST_ValidationLists<>(validationLists);
	}
	...
	static class UtxoTestSetBuilder {
		...
		public TEST_UtxoTestSet build() throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
			return new TEST_UtxoTestSet(peopleSize,
					utxoTxNumber,
					maxUtxoTxOutput,
					maxValue,
					txNumberPerTest,
	...
	private final TEST_ValidationLists<Transaction> validationLists;
	 ...
	 */
	private TEST_UtxoTestSet(int peopleSize, int utxoTxNumber, int maxUtxoTxOutput, double maxValue, int txNumberPerTest,
	...
	private TEST_ValidationLists<Transaction> generateTrxWithCorruptedSignaturePercentage()
			throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
		...
		return TEST_ValidationLists.builder(Transaction.class)
				.setValid(valid)
				.setInvalid(invalid)
