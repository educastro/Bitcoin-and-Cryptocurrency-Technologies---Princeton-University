 ...
 */
public class TEST_ValidationLists<E> {
	private final List<E> valid;
	private final List<E> invalid;
	private final List<E> conflicted;
	
	private TEST_ValidationLists(final List<E> valid, final List<E> invalid, final List<E> conflicted) {
		super();
	...
	public TEST_ValidationLists(TEST_ValidationLists<E> original) {
	...
	public static final class Builder<E>{
		...
		TEST_ValidationLists<E> build() {
			return new TEST_ValidationLists<>(valid, invalid, conflicted);
		}
